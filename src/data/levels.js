...
export const CAMPAIGN_LEVELS = [
  ...
  { id: 3, name: 'Stoneback Ridge', mx: 180, my: 570,  icon: 'mountain', startGold: 135, waves: 4, enemiesPerWave: 10, description: 'Trolls hurl boulders from the ridgeline. Reach them before they reach you.', unlocks: { towers: [], enemies: ['werebear'] }, waveProgression: { skeleton: [3, 2], slime: [2, 1], orc: [2, 4], skeletonArcher: [1, 3], werebear: [0, 3] } },
